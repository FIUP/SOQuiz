let  quiztitle = "Quiz Sistemi Operativi";
...
let quizCompitino1 = [
    ...
    {
        "question"      :   "Q2: Il meccanismo di context-switch è operato dallo scheduler dei processi",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q3 Una system call dà sempre luogo ad un mode switch tra modalità utente e modalità kernel",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q4: Un process switch tra processi utente avviene sempre contestualmente a 2 mode switch (utente->kernel, kernel->utente)",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q5: Un interrupt viene gestito in modalità utente",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q6: Se un processo è in blocco da 10 ms significa che 10ms fa ha eseguito una system call",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q7: Ogni interrupt è associato ad un processo che ha richiesto una operazione di I/O",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q8: Un processo per lanciare un nuovo processo deve fare una system call",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q9: Gli interrupt sono asincroni mentre le chiamate di sistema (trap) sono sincrone",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q10: Una system call generata da un processo utente viene gestita in modalità utente",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q11: In riferimento allo scheduling di processi, la politiche FIFO ed LRU fanno entrambe parte della categoria degli stack algorithms",
    "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
    "question"      :   "Q12: Il meccanismo dei semafori consente forme più generali di sincronizzazione tra processi rispetto alla mutua esclusione",
    "choices"       :   [
                                "V",
                                "F",
                            ],
...
let quizCompitino2 = [
    ...
    {
        "question"      :   "Q3: La paginazione consente a due processi di condividere una pagina",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q4: In un sistema a paginazione la traduzione degli indirizzi mantiene l'offset intatto",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q5: Il TLB consente di ridurre gli accessi alla tabella delle pagine",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q6: La strategia di allocazione contigua può comportare frammentazione esterna",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q7: L'ampiezza dello spazio di indirizzamento virtuale dipende dalla dimensione in bit degli indirizzi",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q8: Per deframmentare un disco occorre prima riformattarlo",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q9: Sia dato un sistema di memoria con indirizzi virtuali suddivisi in 4 campi: a, b, c, d, i primi 3 dei quali siano utilizzati per indirizzare tre livelli gerarchici di tabelle delle pagine e il quarto campo rappresenti l’offset entro la pagina selezionata. Indicare dall’ampiezza di quali campi dipende il numero di pagine indirizzate nel sistema:",
        "choices"       :   [
                                "da quella di tutti e quattro i campi",
                                "da quella del campo d",
                                "da quella del campo a e d",
    ...
    {
        "question"      :   "Q10: La dimensione di una FAT dipende da:",
        "choices"       :   [
                                "la quantità di file memorizzati su disco",
                                "il numero di partizioni virtuali di un disco",
                                "la contiguità con cui sono scritti i file su disco",
    ...
    {
        "question"      :   "Q11: La tecnica di allocazione contigua è soggetta al problema della frammentazione esterna",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q12: Un indirizzo logico identifica direttamente una cella di memoria fisica",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q13: La tecnica di compattazione della memoria non comporta la rilocazione dei programmi",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q14: La tecnica di paginazione è soggetta alla frammentazione interna ma non a quella esterna",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q15: Un page fault avviene quando la entry richiesta non è presente nel Trasnlation Lookaside Buffer(TLB)",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q16: In un sistema combinato di paginazione/segmentazione lo spazio di indirizzamento utente è suddiviso in un certo numero di pagine a dimensione fissa, che a loro turno sono suddivise in un certo numero di segmenti",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q17: In un sistema di memoria a paginazione, il Translation Lookaside Buffer (TLB) velocizza la traduzione di indirizzi fisici in indirizzi virtuali",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q18: Nella gestione della memoria con paginazione, il fenomeno della frammentazione interna è tanto meno rilevante quanto più la lunghezza media dei programmi è grande rispetto alla dimensione della pagina",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q19: Il nome e la dimensione sono due attributi di un file",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q20: Molti page fault su un processo non modificano le prestazioni degli altri processi",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q21: NTFS è il file system più utilizzato dai sistemi operativi GNU/Linux",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q22: Con NTFS è possibile che il file system scriva il contenuto di file di piccola dimensione (es. <1KB) direttamente nel record dell’MFT",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q23: rmdir è un comando GNU/Linux per rinominare directory",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q24: FAT è un file system ad allocazione concatenata",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q25: pwd è un comando GNU/Linux per modificare la password",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q26: L’i-node contiene al suo interno i dati dei file (es. il testo scritto da un utente in un file .txt)",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q27: Il termine copy-on-write indica il caso in cui ad ogni modifica di una variabile in memoria RAM si procede immediatamente con l’aggiornamento anche della sua copia su partizione di disco",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q28: La dimensione max di un file ottenibile con ext2fs dipende dalla contiguità con cui sono scritti i blocchi del file su disco?",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q29: La dimensione max di un file ottenibile con FAT dipende dalla contiguità con cui sono scritti i blocchi del file su disco?",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q30: La dimensione max di un file ottenibile con NTFS dipende dalla contiguità con cui sono scritti i blocchi del file su disco?",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q31: Nella gestione della memoria virtuale tramite paginazione, l’uso di una tabella delle pagine invertita è:",
        "choices"       :   [
                                "più utile in un sistema con indirizzi a 32 bit rispetto a un sistema con indirizzi a 64 bit",
                                "più utile in un sistema con indirizzi a 64 bit rispetto a un sistema con indirizzi a 32 bit",
                                "sconsigliabile rispetto all’uso di una tabella delle pagine regolare nei sistemi moderni",
    ...
    {
        "question"      :   "Q32: Data un disco ampio 4 GB, con blocchi ampi 4 KB, e contenente 128 K file, l’ampiezza in B della FAT dipende da",
        "choices"       :   [
                                "il numero di file in essa rappresentati",
                                "l’ampiezza dei blocchi",
                                "l’ampiezza del disco in blocchi e l’ampiezza degli indici di blocco",
    ...
    {
        "question"      :   "Q33: La dimensione della Tabella delle Pagine Invertita dipende da:",
        "choices"       :   [
                                "l’ampiezza in Pagine del disco",
                                "l’ampiezza in Pagine della RAM",
                                "l’ampiezza in Pagine della Memoria Virtuale",
    ...
    {
        "question"      :   "Q34: “La dimensione massima di un file ottenibile dal File System dipende dalla contiguità con cui sono scritti i suoi blocchi su disco”. Questa affermazione è vera per",
        "choices"       :   [
                                "FAT",
                                "ext2",
                                "entrambi (sia FAT, sia ext2)",
    ...
    {
        "question"      :   "Q35: La gestione della memoria con segmentazione può ridurre il consumo di memoria, in quanto consente a più processi di condividere blocchi di codice e di dati",
        "choices"       :   [
                                "V",
                                "F",
                            ],
    ...
    {
        "question"      :   "Q36: In quale tra i seguenti sistemi operativi è più conveniente l’utilizzo di Inverted Page Tables",
        "choices"       :   [
                                "nessuno dei seguenti, il vantaggio è pari per tutti",
                                "sistemi a 16 bit",
                                "sistemi a 32 bit",
